class GamedayConfig:
    ...
    parser_inning_pitch = ['des', 'des_es', 'id', 'type', 'tfs', 'tfs_zulu', 'x', 'y', 'on_1b', 'on_2b', 'on_3b', 'sv_id', 'start_speed', 'end_speed', 'sz_top', 'sz_bot', 'pfx_x', 'pfx_z', 'px', 'pz', 'x0', 'y0', 'z0', 'vx0', 'vy0', 'vz0', 'ax', 'ay', 'az', 'break_y', 'break_z','break_x','break_angle', 'break_length', 'pitch_type', 'type_confidence', 'zone', 'nasty', 'spin_dir', 'spin_rate', 'cc', 'mt'];
    parser_inning_action = ['b', 's', 'o', 'score', 'des', 'event', 'event2', 'event3', 'tfs', 'player', 'pitch', 'tfs_zulu', 'home_team_runs', 'away_team_runs'];
    parser_inning_atbat = ['num', 'b', 's', 'o', 'start_tfs', 'start_tfs_zulu', 'batter', 'stand', 'b_height', 'pitcher', 'p_throws', 'des', 'des_es', 'event', 'event2', 'event3', 'event4', 'score', 'home_team_runs', 'away_team_runs'];
    ...
    parser_game_gameinfo = ['type', 'home', 'away', 'local_game_time', 'game_pk', 'game_time_et', 'gameday_sw', 'stadiumID', 'away_games_back_wildcard', 'home_games_back_wildcard'];
